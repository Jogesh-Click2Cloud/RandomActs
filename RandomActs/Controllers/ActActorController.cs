...
namespace RandomActs.Controllers
{
    public class ActActorController : Controller
    {
        ...
        public ActionResult AttendeeList(int? id)
        {
            ...
            {
                ViewBag.Registered = randomAct.Actors.Count;
            ...
            return View(randomactactors.ToList());
        }
        ...
        public ActionResult Register([Bind(Include = "RandomActActorId,RandomActId,RandomActorId,WhatICanBring,Message,WaitList")] RandomActActor randomactactor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="RandomActActorId,RandomActId,RandomActorId,WhatICanBring,Message,WaitList")] RandomActActor randomactactor)
        {
